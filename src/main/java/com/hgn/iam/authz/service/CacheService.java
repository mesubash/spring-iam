...
public class CacheService {
    ...
    public static class PolicySnapshot {
        ...
        public static PolicySnapshot fromPolicy(com.hgn.iam.authz.entity.Policy policy) {
        ...
        public com.hgn.iam.authz.entity.Policy toPolicy() {
            return com.hgn.iam.authz.entity.Policy.builder()
                    .id(id)
                    .name(name)
